...
static uint32_t pkt_tx_cnt = 0, pkt_rx_cnt = 0;
static uint32_t bytes_tx_acc = 0, bytes_rx_acc = 0;   /* acumuladores */
...
static void fill_node_metrics_packet(node_metrics_packet_t *metrics) {
    ...
    metrics->volume_bytes    = bytes_tx_acc + bytes_rx_acc;
