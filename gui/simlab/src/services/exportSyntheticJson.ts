...
export function exportSyntheticExperiment(params: {
  ...
  return {
    ...
    parameters: {
      ...
      // Encoded as a P1 problem (continuous relay placement). The relay
      // coordinates generated by the P1 adapter are the benchmark's decision
      // variables. `name` MUST be the canonical 'problem1' key — the mo-engine
      // resolves the adapter and restores chromosomes by this exact value.
      problem: {
        name: 'problem1',
